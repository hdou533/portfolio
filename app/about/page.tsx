...
const About = () => {
  return (
    <div className='w-full h-auto p-8 text-justify flex flex-col justify-center items-center gap-8 lg:w-[80%] 2xl:w-[60%]'>
      ...
      <div className='grid auto-cols-auto grid-flow-row md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 '>
