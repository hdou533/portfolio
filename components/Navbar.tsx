...
const Navbar = () => {
    return (
      <div className='w-full h-12 left-0 bottom-0 bg-color-bg text-white flex text-[0.6rem] fixed lg:justify-center lg:text-sm lg:static xl:text-base z-10 lg:z-0'>
